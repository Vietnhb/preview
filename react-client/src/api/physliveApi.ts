...
export const moveLibraryItem = (id: string, folderId: string) => axiosClient.patch<LibraryItem>(`/library/${id}/folder`, { folderId }).then(r => r.data);
export const renameLibraryItem = (id: string, title: string) => axiosClient.patch<LibraryItem>(`/library/${id}`, { title }).then(r => r.data);
export const deleteLibraryItem = (id: string) => axiosClient.delete(`/library/${id}`);
