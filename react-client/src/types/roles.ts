 ...
 * - REVIEWER: Reviews shared simulations, manages content quality
 * 
...
export const PLATFORM_ROLES: RoleType[] = [ROLE_NAMES.ADMIN, ROLE_NAMES.REVIEWER];
...
export const CONTENT_REVIEW_ROLES = [ROLE_NAMES.REVIEWER, ROLE_NAMES.ADMIN] as const;
