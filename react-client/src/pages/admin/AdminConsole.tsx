...
type CurriculumKind = "topic" | "module" | "level" | "lesson";
...
const roleLabels: Record<string, string> = { ADMIN: "Quản trị viên", TEACHER: "Giáo viên", STUDENT: "Học sinh", REVIEWER: "Reviewer" };
const apiMessage = (error: unknown, fallback: string) => axios.isAxiosError<{ message?: string }>(error)
...
function curriculumPath(kind: CurriculumKind, parentId: string) {
...
function curriculumParentOptions(kind: CurriculumKind, tree: CurriculumTree | null) {
