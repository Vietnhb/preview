...
public class ApplicationsSolver implements PhysicsSolver {
    ...
    public ApplicationsSolver() {
        this(List.of(new com.example.backend.physics.solver.circuits.CircuitApplicationsSolver(),
                new com.example.backend.physics.solver.waves.WaveApplicationsSolver(),
                new com.example.backend.physics.solver.modern.ModernApplicationsSolver(),
                new com.example.backend.physics.solver.practical.PracticalApplicationsSolver()));
    }
