...
public record CtReconstructionParameters(double incidentIntensity, double attenuationCoefficient,
    ...
    public double lineIntegral() { return attenuationCoefficient * pathLength; }
    public double transmittedIntensity() { return incidentIntensity * Math.exp(-lineIntegral()); }
    public double angularStep() { return 2 * Math.PI / projectionCount; }
}
