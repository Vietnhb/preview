...
public class CircuitSolver implements PhysicsSolver {
    ...
    public SolverOutput solve(JsonNode specification, Map<String, Double> overrides,
        ...
        double voltage = PhysicsValues.require(specification, overrides, "voltage", "source_voltage", "initial_voltage", "v0");
        double resistance = positive(PhysicsValues.require(specification, overrides, "resistance", "r"));
