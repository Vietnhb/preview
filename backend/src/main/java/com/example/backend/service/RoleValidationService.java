...
public class RoleValidationService {
    ...
    public void validateRoleSchoolConsistency(String roleName, School school) {
        if (RoleConstants.isPlatformRole(roleName)) {
            if (school != null) {
        ...
        } else if (RoleConstants.isSchoolRole(roleName)) {
            if (school == null) {
                throw new ApiException(
                    HttpStatus.BAD_REQUEST,
    ...
    public void validateSingleSchoolManager(UUID schoolId, Integer excludeUserId) {
        ...
        if (excludeUserId != null) {
            ...
            if (existingUser != null 
                ...
                && RoleConstants.SCHOOL_MANAGER.equals(existingUser.getRole().getName())
    ...
    public boolean canManageSchool(User user, UUID targetSchoolId) {
        ...
        if (RoleConstants.SCHOOL_MANAGER.equals(roleName)) {
