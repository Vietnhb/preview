...
import com.example.backend.physics.compatibility.legacy.reference.waves.StandingWaveReferenceSolver;
import com.example.backend.physics.compatibility.legacy.reference.waves.WaveReflectionReferenceSolver;
import com.example.backend.physics.compatibility.legacy.reference.waves.WavePulseReferenceSolver;
import com.example.backend.physics.compatibility.legacy.reference.waves.SoundWaveReferenceSolver;
import com.example.backend.physics.compatibility.legacy.reference.waves.WaveSuperpositionReferenceSolver;
import com.example.backend.physics.compatibility.legacy.solver.waves.StandingWaveSolver;
import com.example.backend.physics.compatibility.legacy.solver.waves.WaveReflectionSolver;
import com.example.backend.physics.compatibility.legacy.solver.waves.WavePulseSolver;
import com.example.backend.physics.compatibility.legacy.solver.waves.SoundWaveSolver;
import com.example.backend.physics.compatibility.legacy.solver.waves.WaveSuperpositionSolver;
